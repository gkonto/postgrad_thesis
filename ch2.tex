...
\begin{itemize}
	\item{\emph{\en{OMP\_SCHEDULE}}}
	\item{\emph{\en{OMP\_NUM\_THREADS}}}
	\item{\emph{\en{OMP\_DYNAMIC}}}
	\item{\emph{\en{OMP\_PROC\_BIND}}}
	\item{\emph{\en{OMP\_PLACES}}}
	\item{\emph{\en{OMP\_STACKSIZE}}}
	\item{\emph{\en{OMP\_WAIT\_POLICY}}}
	\item{\emph{\en{OMP\_MAX\_ACTIVE\_LEVELS}}}
	\item{\emph{\en{OMP\_NESTED}}}
	\item{\emph{\en{OMP\_THREAD\_LIMIT}}}
	\item{\emph{\en{OMP\_CANCELLATION}}}
	\item{\emph{\en{OMP\_DISPLAY\_ENV}}}
	\item{\emph{\en{OMP\_DISPLAY\_AFFINITY}}}
	\item{\emph{\en{OMP\_AFFINITY\_FORMAT}}}
	\item{\emph{\en{OMP\_DEFAULT\_DEVICE}}}
	\item{\emph{\en{OMP\_MAX\_TASK\_PRIORITY}}}
	\item{\emph{\en{OMP\_TARGET\_OFFLOAD}}}
	\item{\emph{\en{OMP\_TOOL}}}
	\item{\emph{\en{OMP\_TOOL\_LIBRARIES}}}
	\item{\emph{\en{OMP\_DEBUG}}}
	\item{\emph{\en{OMP\_ALLOCATOR}}}
\end{itemize}
